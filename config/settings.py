...
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'akmalmadakimov6@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'lefpyxzqpeqpoona')
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'noreply@crm-rental.com')
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "rental.OrderItem": "fas fa-cube",
        "rental.Payment": "fas fa-money-bill-wave",
        "rental.ReturnDocument": "fas fa-undo",
        "rental.ReturnItem": "fas fa-undo-alt",
        "rental.OrderExcludedDay": "fas fa-cloud-rain",
        "inventory.Product": "fas fa-box",
        "inventory.Category": "fas fa-tags",
        "inventory.Warehouse": "fas fa-warehouse",
        "company.CompanyProfile": "fas fa-building",
        "main.UserProfile": "fas fa-id-card",
        "main.DirectorMessage": "fas fa-envelope",
        "main.ActivityLog": "fas fa-history",
        "main.RainDay": "fas fa-cloud-showers-heavy",
    },
